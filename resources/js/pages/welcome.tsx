    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-gray-100 p-6 dark:bg-gray-900">
                ...
                {/* Pricing Section */}
                <section className="w-full max-w-7xl px-6 py-20">
                    <h2 className="mb-12 text-center text-4xl font-extrabold text-gray-900 dark:text-white">Simple & Transparent Pricing</h2>
                    <div className="grid gap-10 md:grid-cols-3">
                        {/* Free Plan */}
                        <div className="flex flex-col rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
                            <h3 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">Free</h3>
                            <p className="mb-6 text-5xl font-extrabold text-gray-900 dark:text-white">
                                $0<span className="text-lg font-normal text-gray-500 dark:text-gray-400">/month</span>
                            </p>
                            <ul className="mb-8 flex-grow space-y-2 text-gray-700 dark:text-gray-300">
                                <li>✔️ Up to 50 notes</li>
                                <li>✔️ 1 Workspace</li>
                                <li>✔️ 3 Categories</li>
                                <li>✔️ 10 Tags</li>
                                <li>✔️ Basic search</li>
                            </ul>
                            <Link
                                href={route('register')}
                                className="block w-full rounded-lg bg-blue-600 px-6 py-3 text-center font-semibold text-white transition duration-300 hover:bg-blue-700"
                            >
                                Get Started
                            </Link>
                        </div>
                        ...
                        {/* Pro Plan */}
                        <div className="flex flex-col rounded-lg border-2 border-blue-600 bg-white p-8 shadow-lg dark:bg-gray-800">
                            <h3 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">Pro</h3>
                            <p className="mb-6 text-5xl font-extrabold text-gray-900 dark:text-white">
                                $9<span className="text-lg font-normal text-gray-500 dark:text-gray-400">/month</span>
                            </p>
                            <ul className="mb-8 flex-grow space-y-2 text-gray-700 dark:text-gray-300">
                                <li>✔️ Unlimited notes</li>
                                <li>✔️ 5 Workspaces</li>
                                <li>✔️ 20 Categories</li>
                                <li>✔️ 100 Tags</li>
                                <li>✔️ Full-text search</li>
                            </ul>
                            <Link
                                href={route('register')}
                                className="block w-full rounded-lg bg-blue-600 px-6 py-3 text-center font-semibold text-white transition duration-300 hover:bg-blue-700"
                        ...
                        {/* Premium Plan */}
                        <div className="flex flex-col rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
                            <h3 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">Premium</h3>
                            <p className="mb-6 text-5xl font-extrabold text-gray-900 dark:text-white">
                                $19<span className="text-lg font-normal text-gray-500 dark:text-gray-400">/month</span>
                            </p>
                            <ul className="mb-8 flex-grow space-y-2 text-gray-700 dark:text-gray-300">
                                <li>✔️ Unlimited notes & workspaces</li>
                                <li>✔️ Unlimited categories</li>
                                <li>✔️ Unlimited tags</li>
                                <li>✔️ Advanced search</li>

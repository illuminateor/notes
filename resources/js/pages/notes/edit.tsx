                    ...
                    <div className="flex w-full flex-col space-y-4 md:w-2/3">
                        ...
                        <div className="flex flex-grow flex-col">
                            ...
                            <div className="flex-grow rounded-md border border-gray-300 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <EditorContent editor={editor} className="prose dark:prose-invert min-h-0 max-w-none focus:outline-none" />
                                ...
                                <CardContent className="flex flex-col gap-2 p-0">
                                    <div className="relative">
                                        <Input
                                            ...
                                            className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-700 dark:text-white"
                                        />
                                        {data.category && (
                                            <button
                                                onClick={handleClear}
